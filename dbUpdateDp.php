...
?> 
    ...
    <div>
        ...
        <label for="" class="lblvalue"><?= number_format($threemos, 0, '.', ' '); ?></label>
    </div>
    <div>
        <label class="lbltitle" for="">6 months</label>
        <label for="" class="lblvalue"><?= number_format($sixmos, 0, '.', ' '); ?></label>
    </div>
    <div>
        <label class="lbltitle" for="">10 months</label>
        <label for="" class="lblvalue"><?= number_format($tenmos, 0, '.', ' '); ?></label>
    </div>
    <div>
        <label class="lbltitle" for="">1 year</label>
        <label  for="" class="lblvalue"><?= number_format($oneyear, 0, '.', ' '); ?></label>
    </div>    
<?php
        }else{
?>
